      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12 z-10 bg-black/50 backdrop-blur-sm">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button href="/auth/google" type="button" className="w-full h-12 border border-white/10 rounded-xl flex items-center justify-center gap-3 hover:bg-white/5 transition-all text-sm font-medium">
